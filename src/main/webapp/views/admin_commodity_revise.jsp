    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 商品·修改</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> 修改商品</h4>
                        <form class="form-horizontal style-form" method="post" action="/admin_commodity_revise?id=${id}">
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·商品编号：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="id" value="${ShopGoods.getId()}" disabled="disabled">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·商品名称：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="commodityName" value="${ShopGoods.getCommodityName()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·类别：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="category" value="${ShopGoods.getCategory()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·库存：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="stock" value="${ShopGoods.getStock()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·价格：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="price" value="${ShopGoods.getPrice()}">
                                </div>
                            </div>
