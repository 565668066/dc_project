    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 学校活动·修改</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> 修改学校活动</h4>
                        <form class="form-horizontal style-form" method="post" action="/admin_schoolMessage_revise?id=${id}">
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·负责部门：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="department" value="${schoolMessage.getDepartment()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·标题：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="title" value="${schoolMessage.getTitle()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·发布时间：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="newsTime" value="${schoolMessage.getNewsTime()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·负责人：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="manager" value="${schoolMessage.getManager()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·联系方式：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="contact" value="${schoolMessage.getContact()}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·内容：</label>
                                <div class="col-sm-11">
                                    <textarea class="form-control" name="content" height="auto" rows="5" >${schoolMessage.getContent()}</textarea>
                                </div>
                            </div>
                            <div><br>${error}</div>
                            <div class="form-group">
