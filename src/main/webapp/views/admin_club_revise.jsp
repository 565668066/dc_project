...
<head>
    ...
    <link href="/statics/css/to-do.css" rel="stylesheet">
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 社团·修改</h3>
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <form class="form-horizontal style-form" method="post" action="/admin_club_revise?id=${id}">
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·社团编号：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="id" value="${club.getId()}" disabled="disabled" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·社团名称：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="clubName" value="${club.getClubName()}">
                                </div>
                            </div>
                            <div class="form-group">
