    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 学校活动·添加</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> 活动基本信息</h4>
                        <form class="form-horizontal style-form" action="/admin_schoolMessage_add" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="newsTime" placeholder="xxxx-xx-xx">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <textarea class="form-control" name="content" height="auto" rows="5"></textarea>
                                </div>
                            </div>
                            <div><br>${error}</div>
                            <div class="form-group">
