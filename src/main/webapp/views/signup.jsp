    ...
    <div class="container">
        ...
        <form class="form-login" action="/signup" method="post">
            ...
            <div class="login-wrap">
                <input type="text" class="form-control" placeholder="姓名(不可更改)" autofocus name="realName">
                <br>
                <input type="text" class="form-control" placeholder="学号(不可更改)" name="id">
                <br>
                <input type="text" class="form-control" placeholder="学院" name="college">
                <br>
                <input type="text" class="form-control" placeholder="用户名" name="username">
                <br>
                <input type="password" class="form-control" placeholder="密码(至少6位)" name="password">
                <br>
