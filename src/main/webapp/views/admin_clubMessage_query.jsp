    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 社团组织活动·信息</h3>
            <div class="row">
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="content-panel">
                            ...
                            <c:forEach var="li" items="${list}">
                                <form action="#" method="get">
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success btn-xs"><a href="/admin_clubMessage_delete?id=${li.id}" >删除</a></button>
                                        </td>
                                        <td>
                                            <button class="btn btn-success btn-xs"><a href="/admin_clubMessage_revise?title=${li.title}">修改</a></button>
                                        </td>
                                    </tr>
                                </form>
                            </c:forEach>
                        ...
                        <div><br>${error}</div>
                        <a href="/admin_clubMessage_add"><button class="btn btn-theme" >添加活动信息</button></a>
                    </div><!-- /content-panel -->
                </div><!-- /col-md-12 -->
            </div><!-- /row -->
        </section><!--/wrapper -->
...
<script>
    ...
    btn.onclick = function () {
        if (select=="clubName") {location.href="/admin_clubMessage_query_by_clubName?clubName="+input;}
        else if (select=="newsTime") {location.href="/admin_clubMessage_query_by_newsTime?newsTime="+input;}
        else if (select=="title") {location.href="/admin_clubMessage_query_by_title?title="+input;}
    }
