...
<div id="fixedbar">
    <div id="accordion">
        ...
        <div class="card">
            ...
            <ul id="collapse1"class="list-group collapse show"  data-parent="#accordion">
                <a href="#section1"><li class="list-group-item">方便食品</li></a>
                <a href="#section2"><li class="list-group-item">休闲食品</li></a>
                <a href="#section3"><li class="list-group-item">其他</li></a>
            </ul>
        </div>
        <div class="card">
            <div class="collapsed card-header">
