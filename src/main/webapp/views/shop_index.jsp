    ...
    <div id="accordion">
        <div class="card">
            <div class="collapsed card-header">
                ...
                <a href="shop_index.html" class="float-right"><span class="badge badge-secondary">more</span></a>
            </div>
            <ul id="collapse0"class="list-group collapse"  data-parent="#accordion">
                <a href="shop_index.html#section1"><li class="list-group-item">火爆商品</li></a>
                <a href="shop_index.html#section2"><li class="list-group-item">优惠专区</li></a>
                <a href="shop_index.html#section3"><li class="list-group-item">入学推荐</li></a>
            </ul>
        </div>
        <div class="card">
            <div class="card-header">
                ...
                <a href="shop_foods.html" class="float-right"><span class="badge badge-secondary">more</span></a>
            </div>
            <ul id="collapse1"class="list-group collapse"  data-parent="#accordion">
                <a href="shop_foods.html#section1"><li class="list-group-item">方便食品</li></a>
                <a href="shop_foods.html#section2"><li class="list-group-item">休闲食品</li></a>
                <a href="shop_foods.html#section3"><li class="list-group-item">其他</li></a>
            </ul>
        </div>
        <div class="card">
            <div class="collapsed card-header">
                ...
                <a href="shop_necessities.html" class="float-right"><span class="badge badge-secondary">more</span></a>
            </div>
            <ul id="collapse2" class="list-group collapse" data-parent="#accordion">
                <a href="shop_necessities.html#section1"><li class="list-group-item">洗化用品</li></a>
                <a href="shop_necessities.html#section2"><li class="list-group-item">宿舍用品</li></a>
                <a href="shop_necessities.html#section3"><li class="list-group-item">卫生用品</li></a>
            </ul>
        </div>
        <div class="card">
            <div class="card-header">
                ...
                <a href="shop_departments.html" class="float-right"><span class="badge badge-secondary">more</span></a>
            </div>
            <ul id="collapse3" class="list-group collapse show" data-parent="#accordion">
                <a href="#section1"><li class="list-group-item">针织品</li></a>
                <a href="#section2"><li class="list-group-item">体育用品</li></a>
                <a href="#section3"><li class="list-group-item">鞋帽类</li></a>
                <a href="#section4"><li class="list-group-item">数码产品</li></a>
                <a href="#section5"><li class="list-group-item">文具类</li></a>
            </ul>
        </div>
    </div>
    <!--        <div class="card">
...
<div class="container" id="content">
    ...
    <div class="alert alert-info" id="section3">
        <strong>鞋帽类</strong>
    </div>
    <div class="row row1">
        <div class="card col-md-3 col-sm-6">
    ...
    <div class="alert alert-success" id="section4">
        <strong>数码产品</strong>
    </div>
    <div class="row row1">
        <div class="card col-md-3 col-sm-6" style="max-width: 50%">
    ...
    <div class="alert alert-info" id="section5">
        <strong>文具类</strong>
    </div>
    <div class="row row1">
        <div class="card col-md-3 col-sm-6">
