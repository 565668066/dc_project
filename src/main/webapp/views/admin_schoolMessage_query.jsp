    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 学校活动·信息</h3>
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                                ...
                                <div class="row">
                                    <div class="col-sm-2 col-lg-1 col-md-2">
                                        <select class="btn-theme03 btn" id="select_1">
                                            <option value="clubName">负责部门</option>
                            ...
                            <thead>
                            <tr>
                                <th><i class="fa"></i> 负责部门</th>
                                <th><i class="fa"></i> 发布时间</th>
                                <th><i class="fa"></i> 标题</th>
                                <th><i class="fa"></i> 负责人</th>
                            ...
                            <c:forEach var="li" items="${list}">
                                <form action="#" method="get">
                                    <tr>
                                        <td><a>${li.department}</a></td>
                                        <td><a>${li.newsTime}</a></td>
                                        <td><a>${li.title}</a></td>
                                        <td><a>${li.manager}</a></td>
                                        <td><a>${li.contact}</a></td>
                                        <td>
                                            <button class="btn btn-success btn-xs"><a href="/admin_schoolMessage_delete?id=${li.id}" >删除</a></button>
                                        </td>
                                        <td>
                                            <button class="btn btn-success btn-xs"><a href="/admin_schoolMessage_revise?title=${li.title}">修改</a></button>
                                        </td>
                                    </tr>
                                </form>
                            </c:forEach>
                        ...
                        <div><br>${error}</div>
                        <a href="/admin_schoolMessage_add"><button class="btn btn-theme" >添加活动信息</button></a>
                    </div><!-- /content-panel -->
                </div><!-- /col-md-12 -->
            </div><!-- /row -->
        </section><!--/wrapper -->
...
<script>
    ...
    btn.onclick = function () {
        if (select=="department") {location.href="/admin_schoolMessage_query_by_department?department="+input;}
        else if (select=="newsTime") {location.href="/admin_schoolMessage_query_by_newsTime?newsTime="+input;}
        else if (select=="title") {location.href="/admin_schoolMessage_query_by_title?title="+input;}
    }
