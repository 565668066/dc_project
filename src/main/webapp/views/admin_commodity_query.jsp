    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 商品·信息</h3>
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <thead>
                            <tr>
                                <th><i class="fa"></i> 商品编号</th>
                                <th><i class="fa"></i> 商品名称</th>
                                <th><i class="fa"></i> 商品类别</th>
                                <th><i class="fa"></i> 库存</th>
                                <th><i class="fa"></i> 价格</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="li" items="${list}">
                                <form action="#" method="get">
                                    <tr>
                                        <td><a>${li.id}</a></td>
                                        <td><a>${li.commodityName}</a></td>
                                        <td><a>${li.category}</a></td>
                                        <td><a>${li.stock}</a></td>
                                        <td><a>${li.price}</a></td>
                                        <td>
                                            <button class="btn btn-success btn-xs"><a href="/admin_commodity_delete?id=${li.id}" >删除</a></button>
                                        </td>
                                        <td>
                                            <button class="btn btn-success btn-xs"><a href="/admin_commodity_revise?id=${li.id}">修改</a></button>
                                        </td>
                                    </tr>
                                </form>
                            </c:forEach>
                        ...
                        <div><br>${error}</div>
                        <a href="/admin_commodity_add"><button class="btn btn-theme" >添加活动信息</button></a>
                    </div><!-- /content-panel -->
                </div><!-- /col-md-12 -->
            </div><!-- /row -->
        </section><!--/wrapper -->
...
<script>
    ...
    btn.onclick = function () {
        if (select=="id") {location.href="/admin_commodity_query_by_id?id="+input;}
        else if (select=="commodityName") {location.href="/admin_commodity_query_by_commodityName?commodityName="+input;}
        else if (select=="category") {location.href="/admin_commodity_query_by_category?category="+input;}
    }
