...
<main role="main">
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h1>校园迎新</h1>
                        <p>报到流程+必需品购置</p>
                        <p><a class="btn btn-lg btn-primary" href="/club_index" role="button">了解详情</a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption"><!--text-right-->
                        <h1>资源共享</h1>
                        <p>社团组织信息+校园通知</p>
                        <p><a class="btn btn-lg btn-primary" href="/school_message_index" role="button">了解详情</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img class="rounded-0" src="../statics/img/black.png" alt="Generic placeholder image" width="140" height="140">
                <h2>校园迎新</h2>
                <p>text</p>
