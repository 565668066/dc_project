...
--
-- Table structure for table `shopgoods`
--
...
CREATE TABLE `shopgoods` (
  ...
  `pdctDate` varchar(12) NOT NULL,
  `shelfLife` varchar(5) NOT NULL,
  PRIMARY KEY (`goodsId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `shopgoods`
--

LOCK TABLES `shopgoods` WRITE;
/*!40000 ALTER TABLE `shopgoods` DISABLE KEYS */;
/*!40000 ALTER TABLE `shopgoods` ENABLE KEYS */;
UNLOCK TABLES;
